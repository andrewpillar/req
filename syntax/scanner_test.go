...
func Test_Scanner(t *testing.T) {
	...
	tests := []struct {
		...
		{Op(0), _Arrow, LitType(0), ""},
		{Op(0), _Lbrace, LitType(0), ""},
		{Op(0), _Name, LitType(0), "User"},
		{Op(0), _Assign, LitType(0), ""},
		{Op(0), _Name, LitType(0), "decode"},
		{Op(0), _Name, LitType(0), "json"},
		{Op(0), _Ref, LitType(0), ""},
		{Op(0), _Name, LitType(0), "Resp"},
		{Op(0), _Dot, LitType(0), ""},
		...
		{Op(0), _Semi, LitType(0), ""},
		{Op(0), _Name, LitType(0), "print"},
		{Op(0), _Literal, StringLit, `Hello {$User["login"]}`},
		{Op(0), _Semi, LitType(0), ""},
		{Op(0), _Rbrace, LitType(0), ""},
